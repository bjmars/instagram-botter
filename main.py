...
owner.name=("natrix")
github.url=("https://github.com/Ghepes") 

requirements = "https://github.com/Ghepes/instagram-botter/blob/main/reqs.txt"

owner_repos = "https://github.com/Ghepes?tab=repositories"
howto_use="https://github.com/Ghepes/instagram-botter/blob/main/README.md"         
                                                                                                     
this.code = "https://github.com/Ghepes/instagram-botter/blob/main/main.py"
...
def __main__:
 ...
 print("");print("[1] - Likes ");print("");print("[2] - Views ");print("");print("[1] - Followers ");print("");
   choose=input('> ')
     ...
     gen = main()
       url = req()
        usages = req("https://github.com/Ghepes/")
